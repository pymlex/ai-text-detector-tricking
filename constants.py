...
PREFERENCE_LOGIT_MARGIN = env_float("PREFERENCE_LOGIT_MARGIN", 1.0)
ANALYZE_MARGIN_SAMPLES = env_int("ANALYZE_MARGIN_SAMPLES", 512)
PARAPHRASES_PER_TEXT = env_int("PARAPHRASES_PER_TEXT", 2)

DPO_EPOCHS = env_int("DPO_EPOCHS", 4)
...
DPO_LOGGING_STEPS = env_int("DPO_LOGGING_STEPS", 20)
DPO_MONITOR_EVERY_STEPS = env_int("DPO_MONITOR_EVERY_STEPS", 20)
DPO_MONITOR_VALID_DIVISOR = env_int("DPO_MONITOR_VALID_DIVISOR", 4)
